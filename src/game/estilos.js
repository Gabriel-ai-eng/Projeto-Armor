...
export const es = {
  ...
  perfilFoto: { position: 'absolute', left: '12%', top: '50%', transform: 'translate(-50%, -50%)', height: '82%', aspectRatio: '1', objectFit: 'contain', filter: 'drop-shadow(0 0 5px rgba(0,0,0,0.55))' },
  ...
  perfilFotoImg: { position: 'absolute', left: '12%', top: '50%', transform: 'translate(-50%, -50%)', height: '82%', aspectRatio: '1', objectFit: 'cover', borderRadius: '50%', boxShadow: '0 0 0 2px rgba(255,255,255,0.85), 0 1px 5px rgba(0,0,0,0.55)' },
